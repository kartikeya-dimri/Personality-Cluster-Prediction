...
def run_model():
    ...
    print("\nStarting Grid Search for XGBoost (Feature Selected)...")
    ...
    # Parameter grid
    # With fewer features, we might need deeper trees or different learning rates
    param_grid = {
    ...
    submission_file = os.path.join(OUTPUT_DIR, 'xg_boost_3.csv')
