...
def run_model():
    ...
    print("\nStarting Grid Search for Gradient Boosting (Feature Selected)...")
    
    gb = GradientBoostingClassifier(random_state=42)

    # Parameter grid
    # Since we have fewer features, we might test deeper trees to capture more interactions
    param_grid = {
    ...
    submission_file = os.path.join(OUTPUT_DIR, 'gradient_boosting_classifier_3.csv')
