...
def run_model():
    ...
    # AdaBoost uses Decision Tree stumps (max_depth=1) by default.
    # We can tune the base estimator depth slightly, but usually standard AdaBoost uses simple estimators.
    ada = AdaBoostClassifier(random_state=42, algorithm='SAMME') # 'SAMME' is standard for multi-class
    ...
    submission_file = os.path.join(OUTPUT_DIR, 'adaboost_1.csv')
