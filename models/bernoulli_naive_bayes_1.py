...
def run_model():
    ...
    # --- 3. Train BernoulliNB Model ---
    # binarize=0.0 is the default.
    # Since preprocessing_1 used StandardScaler, the features are centered at 0.
    # binarize=0.0 splits features into "Above Average" (1) and "Below Average" (0).
    ...
    y_pred_encoded = bnb.predict(X_test)
    ...
    # Updated filename
    submission_file = os.path.join(OUTPUT_DIR, 'bernoulli_naive_bayes_1.csv')
