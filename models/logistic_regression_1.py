...
def run_model():
    ...
    # Ideally, we use a solver that supports both L1 and L2 regularization, like 'saga'
    # max_iter needs to be higher for convergence with some solvers
    lr = LogisticRegression(random_state=42, max_iter=1000, solver='saga')
    ...
    submission_file = os.path.join(OUTPUT_DIR, 'logistic_regression_1.csv')
