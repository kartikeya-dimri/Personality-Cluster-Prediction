...
def run_model():
    ...
    print("\nStarting Grid Search for BernoulliNB...")
    
    bnb = BernoulliNB()

    # Since preprocessing_2 used RobustScaler (centering data),
    # the optimal binarization threshold might not be 0.0.
    # We search for the best threshold.
    param_grid = {
        'alpha': [0.01, 0.1, 0.5, 1.0, 2.0, 10.0],
        'binarize': [0.0, 0.5, -0.5, 1.0, -1.0], # Thresholds for mapping to 0/1
    ...
    submission_file = os.path.join(OUTPUT_DIR, 'bernoulli_naive_bayes_2.csv')
