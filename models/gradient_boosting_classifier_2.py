...
def run_model():
    ...
    print("\nStarting Grid Search for Gradient Boosting Classifier (Robust Data)...")
    
    gb = GradientBoostingClassifier(random_state=42)

    # Parameter grid
    # Exploring slightly deeper trees or different learning rates for robust data
    param_grid = {
    ...
    submission_file = os.path.join(OUTPUT_DIR, 'gradient_boosting_classifier_2.csv')
