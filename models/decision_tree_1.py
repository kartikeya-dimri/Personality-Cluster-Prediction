...
def run_model():
    ...
    try:
        ...
        # Original data needed for Label Decoding
    ...
    # Train data (Target is already encoded in preprocessing_1)
    ...
    # scoring='f1_macro' ensures we optimize for the competition metric
    ...
    # We need to map the integers (0, 1, 2...) back to the original Cluster labels
    le = LabelEncoder()
    ...
    submission_file = os.path.join(OUTPUT_DIR, 'decision_tree_1.csv')
