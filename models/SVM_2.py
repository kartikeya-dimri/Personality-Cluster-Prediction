...
def run_model():
    ...
    print("\nStarting Grid Search for SVM (Robust Data)...")
    
    # SVMs benefit from robust scaling as they rely on margin distances
    ...
    submission_file = os.path.join(OUTPUT_DIR, 'SVM_2.csv')
